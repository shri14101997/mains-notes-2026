...
* More **job opportunities** and **higher wages** in cities.
* Ex: **IT boom** in Bangalore and Hyderabad.

---

## 2. Social Factors:

* Better **education**, **healthcare**, and **cultural facilities**.
* Ex: Migration to cities like **Mumbai**, **Delhi**.

---

## 3. Political Factors:

* Govt policies encourage urbanization.
* Ex: **Smart Cities Mission** — 100 modern cities planned.

---

## 4. Environmental Factors:

* Natural disasters drive rural-to-urban migration.
* Ex: **Cyclone Fani (2019)** → Displacement in Odisha.

---

## 5. Infrastructure Development:

* Better **transport** (metros) and **communication** ease urban living.

---

## 6. Demographic Factors:

* **Population growth** increases demand for urban housing and services.
...
| :------------------------------ | :----------------------------- |
| Poverty, Unemployment           | Job opportunities              |
| Poor services                   | Higher wages, Better standards |
| Political instability, violence | Quality education & healthcare |
| Environmental degradation       | Diversity, technology access   |
...
### Adverse Impacts of Urbanization in India 

---

## 1. Environmental Degradation:

* Rise in **pollution**, **deforestation**, **soil erosion**.
* Ex: Expansion of Indian cities → loss of green spaces, severe air pollution.

---

## 2. Overcrowding & Infrastructure Strain:

* **Shortage of affordable housing** and **inadequate transport**.
* Ex: **Mumbai**, **Delhi** urban pressure.

---

## 3. Loss of Agricultural Land:

* Fertile lands converted to real estate.
* Ex: **Bengaluru**, **Hyderabad** outskirts.

---

## 4. Displacement of Rural Residents:

* Forced relocation for urban development projects.

---

## 5. Inequality in Resource Access:

* Slum dwellers lack basic services.
* Ex: **Mumbai**, **Kolkata** slums.

---

## 6. Traffic Congestion & Air Pollution:

* Surge in vehicles = choking cities.
* Ex: **Delhi**, **Bengaluru** worst-hit by air quality issues.
...
* Ex: **Chennai**, **Pune** urban expansion eating forests/wetlands.

---


### Social Problems Associated with Urbanization in India

---

## 1. Social Discrimination:

* Discrimination in **housing, employment, services**.
* Affects **lower castes**, **minorities**, **ethnic groups**.

---

## 2. Change in Family System:

* Shift from **joint families** → **nuclear families**.
* Leads to reduced **support for elderly and children**.

---

## 3. Ghettoization:

* Formation of **segregated slums** by caste/religion.
* Ex: **Dharavi** in **Mumbai**.

---

## 4. Persistence of Caste System:

* Caste-based discrimination continues even in cities.
* **Urban migration** → new forms of **social inequality**.

---

## 5. Social Unrest and Crime:

* Unemployment, poverty = rise in **riots**, **civil unrest**.
* Ex: Incidents of unrest in **Delhi**.

---

## 6. Rise of Gated Communities:

* Exclusive zones for the **wealthy**.
* Widening **social gaps** and **lack of integration**.
